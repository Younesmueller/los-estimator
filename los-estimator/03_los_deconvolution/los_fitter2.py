...
def fit_kernel_to_series(
        ...
        if fit_transition_rate:
            curve_init_params = perform_fit_transition_rates(distro, x_train, y_train, kernel_width, los_cutoff, curve_init_params, curve_fit_boundaries, distro_boundaries, distro_init_params, past_kernels, method, error_fun, fit_transition_rate)
        else:
