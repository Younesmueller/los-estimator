...
def fit_convolution(
    ...
    distro_boundaries, distro_init_params = initialize_distro_parameters(
        distro, distro_boundaries, distro_init_params
    )
    ...
    test_err = obj_fun(
        result.x,
        x_test[train_len - los_cutoff :],
        y_test[train_len - los_cutoff :],
        *args[2:]
    )
