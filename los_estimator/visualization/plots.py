...
class Visualizer:
    ...
    def plot_distribution_comparison(self, estimation_result,
    ...
    def plot_fit_quality_heatmap(self, estimation_result,
                               save_path: Optional[str] = None) -> plt.Figure:
        """
    ...
    def plot_successful_fits(self, estimation_result, 
                           save_path: Optional[str] = None) -> plt.Figure:
        """
    ...
    def plot_error_boxplots(self, estimation_result,
                          save_path: Optional[str] = None) -> plt.Figure:
        """
    ...
    def plot_error_stripplot(self, estimation_result,
                           save_path: Optional[str] = None) -> plt.Figure:
        """
    ...
    def create_summary_report(self, estimation_result,
